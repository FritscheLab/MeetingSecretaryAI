...
Use `scripts/transcript2json.py` to convert a transcript to JSON, run `scripts/json_refine.py` to reduce redundancy and improve readability, and then use `scripts/json2word.py` to create DOCX or Markdown minutes.
